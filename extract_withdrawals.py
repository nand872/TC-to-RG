...
two roles are stated rather than inferred.
    ...
    python3 withdrawals112.py              sweep
    python3 withdrawals112.py --pools      what emitted the event, with labels
    python3 withdrawals112.py --summary
    python3 withdrawals112.py --export     write overlap112.db for analysis11

After --export, set OVERLAP_DB = "overlap112.db" and RELAYER_CUTOFF to a
large number at the top of analysis11.py, then rerun. The cutoff is
...
def export():
    """Write the recipient set in the schema analysis11.py already reads."""
