...
def main():
    ...
    if binding > LAUNCH_BLOCK:
        print("  That is later than {}, so the first months of Railgun".format(
            LAUNCH_LABEL))
        print("  are not covered. Widen railgun11.py first, then rerun")
        print("  funding11.py against the wider shielder set.")
    else:
