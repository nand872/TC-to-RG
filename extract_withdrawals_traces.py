...
rather than silently removed, since that count is itself a finding.
    ...
    python3 extract_withdrawals_traces.py --check          what it will read, no node
    python3 extract_withdrawals_traces.py                  sweep, resumable, Ctrl-C safe
    python3 extract_withdrawals_traces.py --result         intersect and report
"""
